...
def before_request():
	if current_user.is_authenticated:
		current_user.ping()  # ping logged in user
...
def register():
	...
	if form.validate_on_submit():
		...
		db.session.add(user)
		# because the id is needed to for the confirmation token
		db.session.commit()
...
def resend_confirmation():
	...
	flash('A new confiramation email has been sent to you by email.')
	return redirect(url_for('main.index'))
