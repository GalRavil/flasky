...
class APITestCase(unittest.TestCase):
    ...
    def test_bad_auth(self):
        ...
        response = self.client.get(
            ...
            headers=self.get_api_headers('new_user@new.com', '321')
        )
    ...
    def test_token_auth(self):
        ...
        response = self.client.get(
            ...
            headers=self.get_api_headers('new_user@new.com', '123')
        )
        self.assertTrue(response.status_code == 200)
        json_response = json.loads(response.data.decode('utf-8'))
    ...
    def test_posts(self):
        ...
        # get the post from the user as follower
        response = self.client.get(
    ...
    def test_users(self):
        ...
        response = self.client.get(
            ...
            headers=self.get_api_headers('susan@example.com', '321')
        )
        self.assertTrue(response.status_code == 200)
        json_response = json.loads(response.data.decode('utf-8'))
    ...
    def test_comments(self):
        ...
        response = self.client.get(
            url,
            headers=self.get_api_headers('john@example.com', '123'))
        self.assertTrue(response.status_code == 200)
        json_response = json.loads(response.data.decode('utf-8'))
        self.assertTrue(json_response['url'] == url)
        self.assertTrue(json_response['body'] ==
        ...
        # get two comments from the post
        response = self.client.get(
